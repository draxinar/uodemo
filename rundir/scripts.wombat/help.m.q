...
trigger textentry(0x01) {
	...
	Q4VR(this);
	Q457(this, 0x01, "Stuck", text)Q4NS(this, 0x00);
	return(0x00);
}
...
trigger textentry(0x02) {
	Q4CY(this, button, 0x01);
	Q4VR(this);
	Q457(this, 0x01, "Harassment", text)Q4NS(this, 0x00);
	return(0x00);
}
...
trigger textentry(0x03) {
	Q4CY(this, button, 0x01);
	Q4VR(this);
	Q457(this, 0x00, "", text)Q4NS(this, 0x00);
	return(0x00);
}
...
trigger textentry(0x04) {
	Q4CY(this, button, 0x01);
	Q4VR(this);
	Q457(this, 0x01, "Unusable item", text)Q4NS(this, 0x00);
	return(0x00);
}
...
trigger textentry(0x05) {
	Q4CY(this, button, 0x01);
	Q4VR(this);
	Q457(this, 0x01, "Invisible item", text)Q4NS(this, 0x00);
	return(0x00);
}
...
trigger textentry(0x06) {
	Q4CY(this, button, 0x01);
	Q4VR(this);
	Q457(this, 0x01, "Stat/Skill Problem", text)Q4NS(this, 0x00);
	return(0x00);
}
